    ...
    <div className="bg-white rounded-lg shadow-sm flex flex-col h-[270px]">
      ...
      <div className="flex-1 overflow-y-auto p-4 scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-blue-200 ">
        {upcomingEvents.slice(0, 2).map((event, index) => (
          <div key={event.id} className="border border-gray-400 rounded-[5px] p-3 pb-0 mb-4 bg-white relative">
            {/* Student Info Row */}
            <div className="flex items-center gap-2 mb-2 pr-10!">
              <img src={GradIcon} alt="Graduation Cap" className="w-5 h-5 pr-0" />
              <span className="font-semibold text-xs text-black" style={{ fontFamily: 'Inter' }}>{event.studentName}</span>
            </div>
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-black" style={{ fontFamily: 'Inter' }}>{event.office}</span>
            </div>
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-black" style={{ fontFamily: 'Inter' }}>{event.date}</span>
            </div>
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs text-black" style={{ fontFamily: 'Inter' }}>{event.time}</span>
            </div>
