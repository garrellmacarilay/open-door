...
// Import the other page components for Staff
import StaffConsultationSummary from '../ConsultationSummary/StaffConsultationSummary';
...
function StaffContainer() {
  ...
  return (
    <>
        <NavigationProvider module="Staff">
        <MainContent 
            showEditProfileModal={showEditProfileModal}
            setShowEditProfileModal={setShowEditProfileModal}
            editProfileData={editProfileData}
