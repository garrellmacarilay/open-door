  ...
  const stats = [
    {
      ...
      value: totalConsultations?.toLocaleString() || '0',
      change: totalConsultationsChange || 0,
      changeText: `${totalConsultationsChange || 0}% from last month`,
      icon: (
    ...
    {
      title: "Approved",
      value: approved?.toLocaleString() || "0",
      change: approvedChange || 0,
      changeText: `${approvedChange || 0}% from last month`,
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: "Cancelled",
      value: cancelled?.toLocaleString() || "0",
      change: cancelledChange || 0,
      changeText: `${cancelledChange || 0}% last month`,
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
